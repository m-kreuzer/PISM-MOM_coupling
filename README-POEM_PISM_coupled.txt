...
-------------------------------------
  - by Moritz Kreuzer    kreuzer@pik-potsdam.de 
       May 10, 2019
...
differently or already have an environment fullfilling the requirements that 
you want to use.)
...
For compiling copy a compile script by Torsten Albrecht to your folder:
    cp /home/albrecht/pism19/pism1.1/Cmake_stable1.0_login.sh PISM_root
    cd PISM_root/
    ./Cmake_stable1.0_login.sh
...
Like in HOWTO_run_POEM.txt, create subdirectories for input and output files in 
POEM/:
...
run_coupled.sh in your favorite editor and 
 ...
 > set PISM grid parameters and input file links
    ...
    which have been downloaded in 2.
